...
references the other:
  ...
  2. PROFILES config     (./openalex-snapshot.profiles.yaml)
...
Defaults:
  ...
  profiles config path: ./openalex-snapshot.profiles.yaml
